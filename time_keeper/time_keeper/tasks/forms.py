...
from django.forms import ModelForm, TextInput, Textarea, Select, DateTimeInput, TimeField
...
# class TimeKeeperForm(ModelForm):
    
#     class Meta:
#         model = TimeKeeper
#         fields = ['spent_time']
#         widgets = {
#             'spent_time': DateTimeInput(format='%Y-%m-%d %H:%M'),
#         }   
# class TimeForm(forms.Form):
#     from_time = forms.DateTimeField(widget=forms.TimeInput(format='%Y-%m-%d %H:%M'))
